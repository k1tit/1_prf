...
# -*- coding: utf-8 -*-
"""
Просмотр SQLite БД. Запуск из корня проекта (data_quality_checker / job_project_clean):

  python view_table.py
  python view_table.py --table KNA1 --limit 50
  python view_table.py --db db_may.db

БД по умолчанию: config/database.json (поле database).
"""
